$(document).ready(function () {
	$('.aion-tooltip-text').each(function () {
		...
		$.getJSON(url, function (data) {
			...
			obj.innerHTML = "<a class=\"tooltip  quality-" + quality + "\" href=\"https://aioncodex.com/us/item/" + itemId + "\"><b>" + name + "</b></a>";
	...
	$('.shop-item-text').each(function () {
		...
		$.getJSON(url, function (data) {
			...
			var quality = str[2].match("quality-(.*)\"  ")[1];
			//obj.innerHTML = "<a class=\"tooltip  quality-" + quality + "\" href=\"https://aioncodex.com/us/item/" + itemId + "\"><b>" + name + "</b></a>";
			obj.innerHTML = "<a href=\"https://aioncodex.com/us/item/" + itemId + "\" class=\"shop-quality-" + quality + "\">" + name + "</a>";
			$(obj).qtip(qtip_options(itemId));
		})
	})
	...
	$('.aion-tooltip-icon-large').each(function () {
		...
		$.getJSON(url, function (data) {
			...
			var icon = str[1].match("items\/(.*).png")[1];
			var quality = str[2].match("quality-(.*)\"  ")[1];
			obj.innerHTML = "<a href=\"https://aioncodex.com/us/item/" + itemId + "\"><img src=\"https://aioncodex.com/items/" + icon + ".png\" width=\"40\" height=\"40\" /></a>";
			$(obj).qtip(qtip_options(itemId));
		})
	})
	$('.shop-item-icon').each(function () {
		...
		$.getJSON(url, function (data) {
			var str = data.aaData[0];
			var icon = str[1].match("items\/(.*).png")[1];
			obj.innerHTML = "<img src=\"https://aioncodex.com/items/" + icon + ".png\" width=\"50\" height=\"50\" />";
		})
	})
})
