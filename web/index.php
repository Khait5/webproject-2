            ...
            <main class="content-center">
                <div class="panel">
                    ...
                    <div style="padding: 15px;">
                        <h3 style="color:#fff; margin-bottom: 10px;">Welcome to Ancardia!</h3>
                        <p>Opening of Interlude server with classic rates.</p>
                        <p>Join us to remember the good old times, participate in epic sieges and fight for the right to become a legend!</p>

                        <div style="margin-top:20px; text-align:center;">
                            <?php if (!isset($_SESSION['account'])): ?>
                                <a href="modules/auth/register.php" class="btn" style="width: 200px;">Join Now</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="panel-footer"></div>
